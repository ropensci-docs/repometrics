...
First of all, thanks for considering contributing to `repometrics`! 👍
It’s people like you that make it rewarding for us - the project
maintainers - to work on `repometrics`. 😊
...
- new_issue:
  <https://github.com/ropensci-review-tools/repometrics/issues/new>
- website: <https://docs.ropensci.org/repometrics/>
- citation:
  <https://ropensci-review-tools.github.io/repometrics/authors.html>
...
Think `repometrics` is useful? Let others discover it, by telling them
...
documentation](https://docs.ropensci.org/repometrics/) to see if you can
find a solution. Still stuck? Post your question as an [issue on
GitHub](https://github.com/ropensci-review-tools/repometrics/issues).
...
list](https://github.com/ropensci-review-tools/repometrics/issues) to
...
Using `repometrics` and discovered a bug? That’s annoying! Don’t let
...
- Include the version of `repometrics` with the following line in your
  `reprex` code:
...
issue](https://github.com/ropensci-review-tools/repometrics/issues/new)
...
Care to fix bugs or implement new functionality for `repometrics`?
Awesome! 👏 Have a look at the [issue
list](https://github.com/ropensci-review-tools/repometrics/issues) and
...
1.  Fork [this
    repo](https://github.com/ropensci-review-tools/repometrics/) and
...
The `repometrics` coding style diverges somewhat from [the commonly used
...
code readability. Code references in `repometrics` are separated by
...
`repometrics` code opts for the former style, with the natural result
