...
1.  "fn_names", with the internal function names of all implemented
    CHAOSS metrics.

2.  "url", with the URL to the CHAOSS community web page describing that
    metric.
...
linked to in the URLs from this function. Adaptations have in particular
been implemented to align metrics with their usage in aggregate
"models".
